...
const LandingPage = () => {
  ...
  const benefitsList = [
    'תגלי איך להפסיק "תחנן" ללקוחות ולהפוך למעצבת שכולם רוצים לעבוד איתה.',
    'סוף סוף תביני למה התוכן שלך לא מביא תוצאות (ואיך לתקן את זה).',
    'תלמדי איך להפוך את הייחודיות שלך ליתרון שיווקי בלתי מנוצח.',
    'תקבלי את הנוסחה המדויקת שעובדת על אוטומט.',
    'תגלי איך להפסיק להתחרות על מחיר ולהתחיל להתחרות על ערך.'
  ];
